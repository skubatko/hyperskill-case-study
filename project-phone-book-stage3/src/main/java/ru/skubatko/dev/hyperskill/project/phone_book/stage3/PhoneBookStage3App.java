package ru.skubatko.dev.hyperskill.project.phone_book.stage3;
...
public class PhoneBookStage3App {
    ...
    private static String getDirectoryName(List<String> directory, int right) {
        String line = directory.get(right);
